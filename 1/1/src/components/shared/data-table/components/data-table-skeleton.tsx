...
interface DataTableSkeletonProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  /**
   * Flag to show the table export action.
   * @default undefined
   * @type boolean | undefined
   */
  ...
  /**
   * Flag to show the count of selected rows.
   * @default true
   * @type boolean | undefined
   */
  withCount?: boolean
    ...
    >
      ...
      {withPagination ? (
        <div className="flex w-full items-center justify-between gap-4 overflow-auto p-1 sm:gap-8">
          {withCount && <Skeleton className="h-7 w-40 shrink-0" />}
          <div className="mx-auto flex items-center gap-4 sm:gap-6 lg:mr-0 lg:ml-auto lg:gap-8">
