...
import { CategoriesPageWrapper } from "@/features/admin/features/categories/components/categories-page-wrapper"
...
export default function CategoriesPage(props: WithRequiredSearchParams) {
  const {
    routes,
    heading: { title, description },
    skeleton: { columnsCount, cellWidths },
  } = ADMIN_TABLE.categories
  ...
  >
    ...
    <span className="hidden sm:inline text-sm capitalize md:text-base">
      ...
      >
        <CategoriesPageWrapper searchParams={props.searchParams} />
      </Suspense>
    </>
  )
}
